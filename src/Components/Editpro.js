...
async    function getData() {
  ...
  <div class="form-group">
    ...
    <input type="text" value={name} class="form-control" onChange={(e)=>setname(e.target.value)} id="exampleInputname" aria-describedby="emailHelp"/>
    
    <label for="exampleInputnum">Product Price</label>
    <input type="integer" value={price}  class="form-control" onChange={(e)=>setprice(e.target.value)} id="exampleInputnum" aria-describedby="emailHelp"/>
    
    <label for="exampleInputdis">Product model</label>
    <input type="text" value={model} class="form-control" onChange={(e)=>setmodel(e.target.value)} id="exampleInputdis" aria-describedby="emailHelp"/>

    <label for="exampleInputnum">No Units</label>
    <input type="Number" value={units} class="form-control" onChange={(e)=>setunits(e.target.value)} id="exampleInputnum" aria-describedby="emailHelp"/>
